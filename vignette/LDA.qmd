...
narrators <- 
  ...
  mutate(
    ...
    narrator = case_when(
      ...
      str_detect(section_names, "chapter") & section_number <= 10 ~ "Victor Frankenstein",
      str_detect(section_names, "chapter") & between(section_number, 11, 16) ~ "The Creature",
      str_detect(section_names, "chapter") & section_number >= 17 ~ "Victor Frankenstein"
    )
  ) |> 
